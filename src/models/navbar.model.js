...
module.exports = {
  ...
  get_navbar_title_content: (data, callback) => {
    dbConn.query(
      'SELECT * FROM title_content WHERE title_content_navbar_title=?',
  ...
  update_navbar_title: (data, callback) => {
    ...
    dbConn.query(
      'UPDATE navbar_content set navbar_content_title=? , navbar_content_slug=? WHERE navbar_content_id=?',
  ...
  update_title_content: (data, callback) => {
    dbConn.query(
      'UPDATE title_content set title_content_title=?, title_content_content=?, title_content_slug=?, title_content_navbar_title=? WHERE title_content_id=?',
      [
        data.title_content_title,
        data.title_content_content,
        data.title_content_slug,
        data.title_content_navbar_title,
        data.title_content_id
      ],
      (error, results, fields) => {
        if (error) {
          return callback(error)
  ...
  delete_title_content: (data, callback) => {
    dbConn.query(
      'DELETE FROM title_content WHERE title_content_id = ?',
      [data.title_content_id],
      (error, results, fields) => {
        if (error) {
          return callback(error)
